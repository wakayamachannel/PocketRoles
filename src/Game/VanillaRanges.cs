    ...
    public static class VanillaRanges
    {
        ...
        private static readonly Spec[] Specs =
        {
            ...
            new Spec { Key = "discuss", Aliases = new[] { "discussion", "discussiontime", "talk", "会議" }, Int = Int32OptionNames.DiscussionTime,
                ...
                Title = StringNames.GameDiscussTime, Seconds = true, NameJa = "議論タイム", NameEn = "Discussion time" },
            ...
            RoleSec("gacd", new[] { "guardiancd", "protectcd", "angelcd", "守護CD" }, FloatOptionNames.GuardianAngelCooldown, 35f, 120f, 5f, "守護天使の護衛クールダウン", "Guardian Angel cooldown"),
            RoleSec("ga", new[] { "protect", "protectduration", "guardian", "angel", "守護時間" }, FloatOptionNames.ProtectionDurationSeconds, 5f, 30f, 2.5f, "護衛持続時間", "Protect duration"),
            ...
            RoleSec("viper", new[] { "dissolve", "dissolvetime", "溶解" }, FloatOptionNames.ViperDissolveTime, 5f, 60f, 2.5f, "バイパーの溶解時間", "Viper dissolve time"),
